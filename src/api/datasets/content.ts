...
export class Api {
  ...
  async adminNewsSummaryInquiry(params: any): Promise<Response> {
    const request = new Request({
      url: '/api/pwm/v1/AdminNewsSummaryInquiry',
      params: params,
      isLoading: true,
      isMessage: true
    })
  ...
  async adminNewsTypeSummaryInquiry(params: any): Promise<Response> {
    const request = new Request({
      url: '/api/pwm/v1/AdminNewsTypeSummaryInquiry',
      params: params,
      isLoading: true,
      isMessage: true
    })
  ...
  async adminNewsCategorySummaryInquiry(params: any): Promise<Response> {
    const request = new Request({
      url: '/api/pwm/v1/AdminNewsCategorySummaryInquiry',
      params: params,
      isLoading: true,
      isMessage: true
    })
  ...
  async adminNewsBrowseSummaryInquiry(params: any): Promise<Response> {
    const request = new Request({
      url: '/api/pwm/v1/AdminNewsBrowseSummaryInquiry',
      params: params,
      isLoading: true,
      isMessage: true
    })
  ...
  async adminNewsTrendListInquiry(params: any): Promise<Response> {
    const request = new Request({
      url: '/api/pwm/v1/AdminNewsTrendListInquiry',
      params: params,
      isLoading: true,
      isMessage: true
    })
  ...
  async adminNewsBrowseListInquiry(params: any): Promise<Response> {
    const request = new Request({
      url: '/api/pwm/v1/AdminNewsBrowseListInquiry',
      params: params,
      isLoading: true,
      isMessage: true
    })
  ...
  async adminNewsBrowseOrderListInquiry(params: any): Promise<Response> {
    const request = new Request({
      url: '/api/pwm/v1/AdminNewsBrowseOrderListInquiry',
      params: params,
      isLoading: true,
      isMessage: true
    })
