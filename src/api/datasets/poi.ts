...
export class Api {
  ...
  async adminWelfareSummaryInquiry(params: any): Promise<Response> {
    const request = new Request({
      url: '/api/pwm/v1/AdminWelfareSummaryInquiry',
      params: params,
      isLoading: true,
      isMessage: true
    })
  ...
  async adminWelfareTrendListInquiry(params: any): Promise<Response> {
    const request = new Request({
      url: '/api/pwm/v1/AdminWelfareTrendListInquiry',
      params: params,
      isLoading: true,
      isMessage: true
    })
  ...
  async adminWelfareBrowseListInquiry(params: any): Promise<Response> {
    const request = new Request({
      url: '/api/pwm/v1/AdminWelfareBrowseListInquiry',
      params: params,
      isLoading: true,
      isMessage: true
    })
  ...
  async adminWelfareBrowseOrderListInquiry(params: any): Promise<Response> {
    const request = new Request({
      url: '/api/pwm/v1/AdminWelfareBrowseOrderListInquiry',
      params: params,
      isLoading: true,
      isMessage: true
    })
