...
class ScreenApi {
  ...
  async adminOverviewInquiry() {
    const request = new Request<any>({
      url: '/api/pwm/v1/AdminOverviewInquiry',
      method: 'post',
      isLoading: true,
      isMessage: true,
      isError: false
  ...
  async adminFeedbackSummaryInquiry() {
    const request = new Request<any>({
      url: '/api/pwm/v1/AdminFeedbackSummaryInquiry',
      method: 'post',
      isLoading: true,
      isMessage: true,
      isError: false
  ...
  async adminHomeSummaryInquiry() {
    const request = new Request<any>({
      url: '/api/pwm/v1/AdminHomeSummaryInquiry',
      method: 'post',
      isLoading: true,
      isMessage: true,
      isError: false
  ...
  async adminWeekTrendListInquiry() {
    const request = new Request<any>({
      url: '/api/pwm/v1/AdminWeekTrendListInquiry',
      method: 'post',
      isLoading: true,
      isMessage: true,
      isError: false
  ...
  async adminWelfareQuantityListInquiry(params: AdminWelfareQuantityListInquiry) {
    const request = new Request<any>({
      url: '/api/pwm/v1/AdminWelfareQuantityListInquiry',
      method: 'post',
      params: params,
      isLoading: false,
      isMessage: true,
