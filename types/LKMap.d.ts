declare namespace LKMap {
  ...
  **/
  ...
  export class Map {
    ...
    public plugin(name: string | Array<any>, callback: any): void
  ...
  export class CircleMarker {
    ...
    /** 设置点标记位置**/
    public setCenter(lnglat: LngLat): void
  ...
  export class InfoWindow {
    ...
    /** 在地图的指定位置打开信息窗体  */
    public open(map: Map, pos: LKMap.LngLat | number[]): void
